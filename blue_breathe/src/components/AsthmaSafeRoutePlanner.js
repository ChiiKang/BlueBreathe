                    ...
                    <div className="mb-4">
                        ...
                        <div className="mt-3 p-2 bg-blue-50 border border-blue-200 rounded-md">
                            <p className="text-xs text-blue-700">
                                This app uses OpenStreetMap for routing and the World Air Quality Index for real-time air quality data.
                            </p>
                        </div>
                    </div>
                        ...
                        <div>
                                ...
                                {routes.map(route => (
                                    ...
                                    >
                                        ...
                                        <div className="flex justify-between text-sm">
                                            ...
                                            <span>
                                                <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${route.avgAQI <= 50 ? 'bg-green-100 text-green-800' :
                            ...
                            <div className="mt-4 p-3 bg-gray-100 rounded-md">
                                ...
                                <p className="text-xs text-gray-500 mt-2">
                                    Based on <a href="https://www.airnow.gov/aqi/aqi-basics/" target="_blank" rel="noopener noreferrer" className="underline text-blue-600">EPA AQI standards</a>.
                                </p>
                            </div>
                        </div>
                    )}
                        ...
                        <div className="bg-white rounded-lg shadow-md p-4 h-full flex flex-col">
                            ...
                            <div className="w-full h-64 mb-4 border border-gray-200 rounded-lg overflow-hidden">
                                {selectedRoute && selectedRoute.points && selectedRoute.points.length >= 2 && (
                                    <MapContainer
                                        center={[3.1390, 101.6869]} // Center of KL as default
                                        zoom={12}
                                    ...
                                    >
                                        ...
                                        {selectedRoute.points.map((point, idx) => {
                                            if (idx === selectedRoute.points.length - 1) return null; // Skip last point
                                            ...
                                            const color =
                                                pointAQI <= 50 ? '#22c55e' :  // Green (Good)
                                                    pointAQI <= 100 ? '#eab308' : // Yellow (Moderate)
                                                        pointAQI <= 150 ? '#f97316' : // Orange (Unhealthy for Sensitive Groups)
                                                ...
                                                >
                                                    <Popup>
                                                        <div>
                                                            ...
                                                            <br />
                                                            <span style={{ color: color }}>●</span> {getAQIStatus(pointAQI)}
                                                        </div>
                                                    </Popup>
                                                </Polyline>
                                            );
                                        ...
                                        <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-gray-200">
                                            {(() => {
                                                ...
                                                if (totalPoints <= 10) {
                                                    ...
                                                    sampledPoints.push(selectedRoute.points[totalPoints - 1]);
                                                }
                                            ...
                                            {(() => {
                                                ...
                                                return sampledPoints.map((point, index) => (
                                                    <div key={index} className="flex flex-col items-center">
                                                        <div className={`w-4 h-4 rounded-full border-2 border-white ${point.aqi <= 50 ? 'bg-green-500' :
                                                                point.aqi <= 100 ? 'bg-yellow-500' :
                                                                    point.aqi <= 150 ? 'bg-orange-500' :
                                                                        'bg-red-500'
                                                            }`}></div>
                            ...
                            <div className="mt-4">
                                ...
                                <div className={`p-3 rounded-md ${selectedRoute?.avgAQI <= 50 ? 'bg-green-50 border border-green-200' :
